  ...
  return (
    <>
      <section className={cn(
        ...
        <div className="flex flex-col justify-start items-center gap-[20px] pt-15 px-11 md:max-w-[1200px]">
          <Image
            width={0}
            height={0}
            src="/images/logo-green.svg"
            alt="renato3x - Logo"
            className="min-w-[166px] md:min-w-[230px]"
          />
          <h1 className="text-white-secondary text-center font-chakra text-[28px] md:text-[48px]">
            Desenvolvimento de Sites e Sistemas Sob Medida – <span className="highlight">Do Front ao Back</span>, com Qualidade e Rapidez
          </h1>
          <p className="text-white-secondary text-center text-[18px] md:max-w-[500px]">
